...
// ***************************************************************************
// Order.Update.CheckedUpdate Function Class
// ***************************************************************************

public final class ST14F_ObFnc extends ObFunction
{
    ////////////////////////////////////////////////////////////////////////////////
    ...
    public ST14F_ObFnc(ObCallMgr obcallmgr)
    {
        super(obcallmgr);
        ST14F_ObDat varObDat = new ST14F_ObDat( this);
        super.setLocalVariable( varObDat);
        setFunctionName("Order.Update.CheckedUpdate");
    ...
    {
        ((ST14F_ObDat)getDatVariable()).getVariable(m_strVarST14F_Environment).getField(m_strFldSqmx0r6).assign(returned);
    }

    public void setReturningStatus(ObCharFld returning)
    {
        ((ST14F_ObDat)getDatVariable()).getVariable(m_strVarST14F_Environment).getField(m_strFldSqmx0r8).assign(returning);
    }

    public ObCharFld getReturningStatus()
    {
        return (ObCharFld)(((ST14F_ObDat)getDatVariable()).getVariable(m_strVarST14F_Environment).getField(m_strFldSqmx0r8));
    }

    public void setCallStatus(ObCharFld status)
    {
        ((ST14F_ObDat)getDatVariable()).getVariable(m_strVarST14F_Environment).getField(m_strFldSqmx0rg).assign(status);
    }
...
//  Initialise the standard set of context variables
        v	= (ST14F_ObDat)fnc.getDatVariable();
        in	= (ST14F_ObIn)fnc.getInVariable();
        out	= (ST14F_ObOut)fnc.getOutVariable();
...
// Set  Environment<*Returning status> = <*Returning status.*Successful>
            v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_0);
...
// If  Environment<*Returning status> IS <State: OBJECTS/*Returning status.*Abnormal>
            if( ((v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).isNotEqual(m_obvalfld_0))) )
            {
...
// Else
            ...
            {
// Set  View = UpdateData
                v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarProdID).assign(in.getVariable(m_strVarST14F_UpdateData).getAsObCharFldField(m_strVarProdID));
                v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarCustID).assign(in.getVariable(m_strVarST14F_UpdateData).getAsObCharFldField(m_strVarCustID));
                v.getVariable(m_strVarST14F_View).getAsObIntFldField(m_strVarOrderQty).assign(in.getVariable(m_strVarST14F_UpdateData).getAsObIntFldField(m_strVarOrderQty));
...
// Update
                ...
                keyFields.addElement(v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarProdID));
                keyFields.addElement(v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarCustID));
                keyFields.addElement(v.getVariable(m_strVarST14F_View).getAsObIntFldField(m_strVarOrderQty));
                keyFields.addElement(v.getVariable(m_strVarST14F_View).getAsObLongFldField(m_strVarOrderID));
                sqlString = "UPDATE ST13V " + 
									"SET ProdID=?, CustID=?, OrderQty=? " + 
									"WHERE " + 
									"( OrderID = ? ) "		;
                getDBMgr().updatex( sqlString, keyFields, this) ;
                getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);

// Set  Environment<*Returning status> = Environment<*View status>
                v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r4));
...
// Fetch EQ  UpdateKey
            keyFields = new Vector<ObField>();
            keyFields.addElement(in.getVariable(m_strVarST14F_UpdateKey).getAsObLongFldField(m_strVarOrderID));
            sqlString = "SELECT OrderID, ProdID, CustID, OrderQty " + 
									"FROM ST13V " + 
									"WHERE " + 
									"( OrderID = ? ) " + 
									"ORDER BY OrderID ";
            getDBMgr().fetchx(sqlString, keyFields, v.getVariable(m_strVarST14F_View), 1, this);
            getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);
...
// If  Environment<*View status> == <*View status.*Successful>
            if( v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r4).isEqual(m_obvalfld_0) )
            {
// Comment  Check each field for changes since the row was read

// If  Original<OrderID> NE  View<OrderID>
                if( in.getVariable(m_strVarST14F_Original).getAsObLongFldField(m_strVarOrderID).isNotEqual(v.getVariable(m_strVarST14F_View).getAsObLongFldField(m_strVarOrderID)) )
                {
// Set  Environment<*Returning status> = <*Returning status.*Error>
                        v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_1);
...
// If  Original<ProductID> NE  View<ProductID>
                if( in.getVariable(m_strVarST14F_Original).getAsObCharFldField(m_strVarProdID).isNotEqual(v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarProdID)) )
                {
// Set  Environment<*Returning status> = <*Returning status.*Error>
                        v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_1);
...
// If  Original<CustomerID> NE  View<CustomerID>
                if( in.getVariable(m_strVarST14F_Original).getAsObCharFldField(m_strVarCustID).isNotEqual(v.getVariable(m_strVarST14F_View).getAsObCharFldField(m_strVarCustID)) )
                {
// Set  Environment<*Returning status> = <*Returning status.*Error>
                        v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_1);
...
// If  Original<OrderQty> NE  View<OrderQty>
                if( in.getVariable(m_strVarST14F_Original).getAsObIntFldField(m_strVarOrderQty).isNotEqual(v.getVariable(m_strVarST14F_View).getAsObIntFldField(m_strVarOrderQty)) )
                {
// Set  Environment<*Returning status> = <*Returning status.*Error>
                        v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_1);
...
// If  Environment<*Returning status> == <*Returning status.*Error>
                if( v.getVariable(m_strVarST14F_Environment).getAsObCharFldField(m_strVarSqmx0r8).isEqual(m_obvalfld_1) )
                {
// Release Lock
...
// ***************************************************************************
    ...
    final class ST14F_ObDat extends ObVariableGroupX
    {
        ////////////////////////////////////////////////////////////////
        // Members
        ...
        ////////////////////////////////////////////////////////////////
        // Constructors
        public ST14F_ObDat(ObFunction fnc)
        {
            super(ObVariableGroup.VT_LOCAL, fnc);
            addVariable("ST14F_Environment", initvarST14F_ST14F_Environment());
            addVariable("ST14F_View", initvarST14F_ST14F_View());
        }

        public ST14F_ObDat(ObApplication obapp)
        {
        ...
        public ObVariableX initvarST14F_ST14F_Environment()
        {
            ObVariableX var = new ObVariableX(this, "varST14F_ST14F_Environment");
        ...
        ////////////////////////////////////////////////////////////////
        // View Variable
        public ObVariableX initvarST14F_ST14F_View()
        {
            ObVariableX var = new ObVariableX(this, "varST14F_ST14F_View");
    ...
    // End Of Order.Update.CheckedUpdate Variable Group
    ////////////////////////////////////////////////////////////////
    ...
    // Variable and Field Names:
        ...
        public final String m_strVarST14F_Original = "ST14F_Original";
        public final String m_strVarSqmx0r8 = "Sqmx0r8";
        public final String m_strFldSqmx0r8 = "Sqmx0r8";
        public final String m_strVarST14F_View = "ST14F_View";
        public final String m_strVarST14F_UpdateData = "ST14F_UpdateData";
        public final String m_strVarSqmx0r4 = "Sqmx0r4";
        public final String m_strVarST14F_Environment = "ST14F_Environment";
        public final String m_strVarProdID = "ProdID";
        public final String m_strVarST14F_UpdateKey = "ST14F_UpdateKey";
