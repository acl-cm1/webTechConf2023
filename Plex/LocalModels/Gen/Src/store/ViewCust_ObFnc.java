...
// Set  Environment<*Object> = Name of WebLogMessages
                v.getVariable(m_strVarViewCust_Environment).getAsObCharFldField(m_strVarSqmx1eu).fromString("WebLogMessages");
// API Call  Source code: WEBCLI60/JAVASetInhPath
                try {
                	panel.getClass().getMethod("addToInhPath", new Class[] { String.class })
                		.invoke(panel, new Object[] { v.getVariable(m_strVarViewCust_Environment).getAsObCharFldField(m_strVarSqmx1eu).toString() });
                } catch (Exception ex) {
                }
...
// Set  Environment<*Object> = Name of WebShell
                v.getVariable(m_strVarViewCust_Environment).getAsObCharFldField(m_strVarSqmx1eu).fromString("WebShell");
// API Call  Source code: WEBCLI60/JAVASetInhPath
                try {
                	panel.getClass().getMethod("addToInhPath", new Class[] { String.class })
                		.invoke(panel, new Object[] { v.getVariable(m_strVarViewCust_Environment).getAsObCharFldField(m_strVarSqmx1eu).toString() });
...
//  The standard set of context variables
        ...
        ObPushbuttonData m_ObPushbuttonData3159 = null; /* X */
...
//  Initialise the standard set of context variables
        ...
        public void clearReferences()
        {
            ...
            if(m_ObPushbuttonData3159 != null) m_ObPushbuttonData3159.clearReferences();
            m_ObPushbuttonData3159 = null; /* X */
...
// Event:  -> Prompt 
            m_ObEditData3154.registerEvent(ObCtrlData.DOUBLECLICK, 3161, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3157.registerEvent(ObCtrlData.DOUBLECLICK, 3161, "Prompt");

            m_ObPushbuttonData3159 = (ObPushbuttonData)bindControl(3159,12293); /* X */
            m_ObPushbuttonData3159.setUniqueName("m_ObPushbuttonData3159");
// Event: X -> Close 
            m_ObPushbuttonData3159.registerEvent(ObCtrlData.PRESSED, 3163, "Close");


            accessPanel(ObCtrlData.WRITE);
            layoutWindow();

            getPanelData().registerLogicalEvent(3161, "Prompt");
            getPanelData().registerLogicalEvent(3163, "Close");
// KeyBoard Event: Prompt 
            getPanelData().registerKeyboardEvent("F4", 3161);
// Event:  -> Close 
            getPanelData().registerEvent(ObCtrlData.QUERYCLOSE, 3163, "Close");
...
// Event  Event: Close
            if( getCurrentAction() == 3163 /* Close */ )
            {
// Go Sub  Close
                ObSbr_ViewCust4();
                if(hasReturned())
...
// Pre Point Events
            {
// Event  Event: Prompt
                if( getCurrentAction() == 3161 /* Prompt */ )
                {
...
// Set State  Hidden, DetailP
        panel.m_ObLabelData3153.setState(12296); /* CustomerID */
        panel.m_ObEditData3154.setState(12297); /*  */
        panel.m_ObLabelData3156.setState(12299); /* CustomerName */
        panel.m_ObEditData3157.setState(12300); /*  */
