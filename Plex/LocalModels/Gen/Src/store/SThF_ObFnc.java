...
// ***************************************************************************
// Product.Update.DeleteRow Function Class
// ***************************************************************************

public final class SThF_ObFnc extends ObFunction
{
    ////////////////////////////////////////////////////////////////////////////////
    ...
    public SThF_ObFnc(ObCallMgr obcallmgr)
    {
        super(obcallmgr);
        SThF_ObDat varObDat = new SThF_ObDat( this);
        super.setLocalVariable( varObDat);
        setFunctionName("Product.Update.DeleteRow");
    ...
    {
        ((SThF_ObDat)getDatVariable()).getVariable(m_strVarSThF_Environment).getField(m_strFldSqmx0r6).assign(returned);
    }

    public void setReturningStatus(ObCharFld returning)
    {
        ((SThF_ObDat)getDatVariable()).getVariable(m_strVarSThF_Environment).getField(m_strFldSqmx0r8).assign(returning);
    }

    public ObCharFld getReturningStatus()
    {
        return (ObCharFld)(((SThF_ObDat)getDatVariable()).getVariable(m_strVarSThF_Environment).getField(m_strFldSqmx0r8));
    }

    public void setCallStatus(ObCharFld status)
    {
        ((SThF_ObDat)getDatVariable()).getVariable(m_strVarSThF_Environment).getField(m_strFldSqmx0rg).assign(status);
    }
...
//  Initialise the standard set of context variables
        v	= (SThF_ObDat)fnc.getDatVariable();
        in	= (SThF_ObIn)fnc.getInVariable();
        out	= (SThF_ObOut)fnc.getOutVariable();
...
// Set  Environment<*Returning status> = <*Returning status.*Successful>
            v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_0);
...
// If  Environment<*Error status> == <*Error status.*Error>
            if( v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0re).isEqual(m_obvalfld_1) )
            {
// Set  Environment<*Returning status> = <*Returning status.*Error>
                v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_2);
...
// Delete  DeleteKey
            ...
            keyFields.addElement(in.getVariable(m_strVarSThF_DeleteKey).getAsObCharFldField(m_strVarProdID));
            sqlString = "DELETE FROM ST6V " + 
									"WHERE " + 
									"( ProdID = ? ) "		;
            getDBMgr().deletex(sqlString, keyFields, this);
            getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);

// Set  Environment<*Returning status> = Environment<*View status>
            v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r4));
...
// Set  Environment<*Error status> = <*Error status.*Normal>
        v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0re).assign(m_obvalfld_0);
...
// Fetch EQ  DeleteKey
        ...
        sqlString = "SELECT ProdID, ProdName, ProdDesc, ProdPrice, QtyInStock " + 
									...
									"( ProdID = ? ) " + 
									"ORDER BY ProdID ";
        getDBMgr().fetchx(sqlString, keyFields, v.getVariable(m_strVarSThF_View), 1, this);
        getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);
...
// When  Environment<*View status> == <*View status.*Successful>
            if( v.getVariable(m_strVarSThF_Environment).getAsObCharFldField(m_strVarSqmx0r4).isEqual(m_obvalfld_0) )
            {
            }
// Otherwise
            else
...
// ***************************************************************************
    ...
    final class SThF_ObDat extends ObVariableGroupX
    {
        ////////////////////////////////////////////////////////////////
        // Members
        ...
        ////////////////////////////////////////////////////////////////
        // Constructors
        public SThF_ObDat(ObFunction fnc)
        {
            super(ObVariableGroup.VT_LOCAL, fnc);
            addVariable("SThF_DeleteL", initvarSThF_SThF_DeleteL());
            addVariable("SThF_Environment", initvarSThF_SThF_Environment());
            addVariable("SThF_View", initvarSThF_SThF_View());
        }

        public SThF_ObDat(ObApplication obapp)
        {
        ...
        ////////////////////////////////////////////////////////////////
        // DeleteL Variable
        public ObVariableX initvarSThF_SThF_DeleteL()
        {
            ObVariableX var = new ObVariableX(this, "varSThF_SThF_DeleteL");
        ...
        public ObVariableX initvarSThF_SThF_Environment()
        {
            ObVariableX var = new ObVariableX(this, "varSThF_SThF_Environment");
        ...
        ////////////////////////////////////////////////////////////////
        // View Variable
        public ObVariableX initvarSThF_SThF_View()
        {
            ObVariableX var = new ObVariableX(this, "varSThF_SThF_View");
    ...
    // End Of Product.Update.DeleteRow Variable Group
    ////////////////////////////////////////////////////////////////
    ...
    // Variable and Field Names:
        ...
        public final String m_strVarSThF_Environment = "SThF_Environment";
        ...
        public final String m_strVarSThF_View = "SThF_View";
