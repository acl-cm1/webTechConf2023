...
// ***************************************************************************
// Customer.Update.UpdateRow Function Class
// ***************************************************************************

public final class STqF_ObFnc extends ObFunction
{
    ////////////////////////////////////////////////////////////////////////////////
    ...
    public STqF_ObFnc(ObCallMgr obcallmgr)
    {
        super(obcallmgr);
        STqF_ObDat varObDat = new STqF_ObDat( this);
        super.setLocalVariable( varObDat);
        setFunctionName("Customer.Update.UpdateRow");
    ...
    {
        ((STqF_ObDat)getDatVariable()).getVariable(m_strVarSTqF_Environment).getField(m_strFldSqmx0r6).assign(returned);
    }

    public void setReturningStatus(ObCharFld returning)
    {
        ((STqF_ObDat)getDatVariable()).getVariable(m_strVarSTqF_Environment).getField(m_strFldSqmx0r8).assign(returning);
    }

    public ObCharFld getReturningStatus()
    {
        return (ObCharFld)(((STqF_ObDat)getDatVariable()).getVariable(m_strVarSTqF_Environment).getField(m_strFldSqmx0r8));
    }

    public void setCallStatus(ObCharFld status)
    {
        ((STqF_ObDat)getDatVariable()).getVariable(m_strVarSTqF_Environment).getField(m_strFldSqmx0rg).assign(status);
    }
...
//  Initialise the standard set of context variables
        v	= (STqF_ObDat)fnc.getDatVariable();
        in	= (STqF_ObIn)fnc.getInVariable();
        out	= (STqF_ObOut)fnc.getOutVariable();
...
// Set  Environment<*Returning status> = <*Returning status.*Successful>
            v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(m_obvalfld_0);
...
// If  Environment<*Returning status> IS <State: OBJECTS/*Returning status.*Abnormal>
            if( ((v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r8).isNotEqual(m_obvalfld_0))) )
            {
...
// Else
            ...
            {
// Set  View = UpdateData
                v.getVariable(m_strVarSTqF_View).getAsObCharFldField(m_strVarCustName).assign(in.getVariable(m_strVarSTqF_UpdateData).getAsObCharFldField(m_strVarCustName));
...
// Update
                ...
                keyFields.addElement(v.getVariable(m_strVarSTqF_View).getAsObCharFldField(m_strVarCustName));
                keyFields.addElement(v.getVariable(m_strVarSTqF_View).getAsObCharFldField(m_strVarCustID));
                sqlString = "UPDATE ST2V " + 
									"SET CustName=? " + 
									"WHERE " + 
									"( CustID = ? ) "		;
                getDBMgr().updatex( sqlString, keyFields, this) ;
                getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);

// Set  Environment<*Returning status> = Environment<*View status>
                v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r8).assign(v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r4));
...
// Fetch EQ  UpdateKey
            keyFields = new Vector<ObField>();
            keyFields.addElement(in.getVariable(m_strVarSTqF_UpdateKey).getAsObCharFldField(m_strVarCustID));
            sqlString = "SELECT CustID, CustName " + 
									"FROM ST2V " + 
									"WHERE " + 
									"( CustID = ? ) " + 
									"ORDER BY CustID ";
            getDBMgr().fetchx(sqlString, keyFields, v.getVariable(m_strVarSTqF_View), 1, this);
            getDBMgr().setViewIOStatusx((ObCharFld)v.getVariable(m_strVarSTqF_Environment).getAsObCharFldField(m_strVarSqmx0r4), this);
...
// ***************************************************************************
    ...
    final class STqF_ObDat extends ObVariableGroupX
    {
        ////////////////////////////////////////////////////////////////
        // Members
        ...
        ////////////////////////////////////////////////////////////////
        // Constructors
        public STqF_ObDat(ObFunction fnc)
        {
            super(ObVariableGroup.VT_LOCAL, fnc);
            addVariable("STqF_Environment", initvarSTqF_STqF_Environment());
            addVariable("STqF_View", initvarSTqF_STqF_View());
        }

        public STqF_ObDat(ObApplication obapp)
        {
        ...
        public ObVariableX initvarSTqF_STqF_Environment()
        {
            ObVariableX var = new ObVariableX(this, "varSTqF_STqF_Environment");
        ...
        ////////////////////////////////////////////////////////////////
        // View Variable
        public ObVariableX initvarSTqF_STqF_View()
        {
            ObVariableX var = new ObVariableX(this, "varSTqF_STqF_View");
    ...
    // End Of Customer.Update.UpdateRow Variable Group
    ////////////////////////////////////////////////////////////////
    ...
    // Variable and Field Names:
        ...
        public final String m_strVarSTqF_View = "STqF_View";
        public final String m_strFldSqmx0rg = "Sqmx0rg";
        public final String m_strVarSTqF_Environment = "STqF_Environment";
