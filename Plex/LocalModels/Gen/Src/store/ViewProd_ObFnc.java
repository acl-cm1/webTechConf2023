...
// Event:  -> Prompt 
            m_ObEditData3154.registerEvent(ObCtrlData.DOUBLECLICK, 3169, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3157.registerEvent(ObCtrlData.DOUBLECLICK, 3169, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3160.registerEvent(ObCtrlData.DOUBLECLICK, 3169, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3163.registerEvent(ObCtrlData.DOUBLECLICK, 3169, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3166.registerEvent(ObCtrlData.DOUBLECLICK, 3169, "Prompt");


            accessPanel(ObCtrlData.WRITE);
            layoutWindow();

            getPanelData().registerLogicalEvent(3169, "Prompt");
            getPanelData().registerLogicalEvent(3170, "Close");
// KeyBoard Event: Prompt 
            getPanelData().registerKeyboardEvent("F4", 3169);
// Event:  -> Close 
            getPanelData().registerEvent(ObCtrlData.QUERYCLOSE, 3170, "Close");
...
// Event  Event: Close
            if( getCurrentAction() == 3170 /* Close */ )
            {
// Go Sub  Close
                ObSbr_ViewProd4();
                if(hasReturned())
...
// Pre Point Events
            {
// Event  Event: Prompt
                if( getCurrentAction() == 3169 /* Prompt */ )
                {
...
// Set State  Hidden, DetailP
        panel.m_ObLabelData3153.setState(12301); /* ProductID */
        panel.m_ObEditData3154.setState(12302); /*  */
        panel.m_ObLabelData3156.setState(12304); /* ProductName */
        panel.m_ObEditData3157.setState(12305); /*  */
        panel.m_ObLabelData3159.setState(12307); /* ProductDescription */
        panel.m_ObEditData3160.setState(12308); /*  */
        panel.m_ObLabelData3162.setState(12310); /* ProductPrice */
        panel.m_ObEditData3163.setState(12311); /*  */
        panel.m_ObLabelData3165.setState(12313); /* QtyInStock */
        panel.m_ObEditData3166.setState(12314); /*  */
