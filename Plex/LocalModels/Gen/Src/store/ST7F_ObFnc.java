...
// Event:  -> Prompt 
            m_ObEditData3154.registerEvent(ObCtrlData.DOUBLECLICK, 3183, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3157.registerEvent(ObCtrlData.DOUBLECLICK, 3183, "Prompt");
...
// Event: GridP -> LoadGrid 
            m_ObGridData3158.registerEvent(ObCtrlData.GRIDLOAD, 3184, "LoadGrid");

// Event: GridP -> SelectGrid 
            m_ObGridData3158.registerEvent(ObCtrlData.GRIDSELECTION, 3185, "SelectGrid");
...
// Event: CustomerName -> Prompt 
            m_ObEditData3166.registerEvent(ObCtrlData.DOUBLECLICK, 3183, "Prompt");
...
// Event:  -> Copy 
            m_ObPushbuttonData3168.registerEvent(ObCtrlData.PRESSED, 3187, "Copy");
...
// Event:  -> RefreshGrid 
            m_ObPushbuttonData3169.registerEvent(ObCtrlData.PRESSED, 3189, "RefreshGrid");
...
// Event: &Delete -> Delete 
            m_ObPushbuttonData3171.registerEvent(ObCtrlData.PRESSED, 3191, "Delete");
...
// Event: &Apply -> Update 
            m_ObPushbuttonData3172.registerEvent(ObCtrlData.PRESSED, 3193, "Update");
...
// Event: &Refresh -> Refresh 
            m_ObPushbuttonData3173.registerEvent(ObCtrlData.PRESSED, 3195, "Refresh");
...
// Event: &New -> New 
            m_ObPushbuttonData3174.registerEvent(ObCtrlData.PRESSED, 3197, "New");
...
// Event: Close -> Close 
            m_ObPushbuttonData3181.registerEvent(ObCtrlData.PRESSED, 3199, "Close");


            accessPanel(ObCtrlData.WRITE);
            layoutWindow();

            getPanelData().registerLogicalEvent(3187, "Copy");
            getPanelData().registerLogicalEvent(3197, "New");
            getPanelData().registerLogicalEvent(3191, "Delete");
            getPanelData().registerLogicalEvent(3184, "LoadGrid");
            getPanelData().registerLogicalEvent(3189, "RefreshGrid");
            getPanelData().registerLogicalEvent(3185, "SelectGrid");
            getPanelData().registerLogicalEvent(3195, "Refresh");
            getPanelData().registerLogicalEvent(3193, "Update");
            getPanelData().registerLogicalEvent(3183, "Prompt");
            getPanelData().registerLogicalEvent(3199, "Close");
// KeyBoard Event: Prompt 
            getPanelData().registerKeyboardEvent("F4", 3183);
// Event:  -> Close 
            getPanelData().registerEvent(ObCtrlData.QUERYCLOSE, 3199, "Close");
...
// Event  Event: Close
            if( getCurrentAction() == 3199 /* Close */ )
            {
// Go Sub  Close
                ObSbr_ST7F4();
                if(hasReturned())
...
// Event  Event: Update
                if( getCurrentAction() == 3193 /* Update */ )
                {
...
// Event  Event: Refresh
                if( getCurrentAction() == 3195 /* Refresh */ )
                {
...
// Event  Event: LoadGrid
                if( getCurrentAction() == 3184 /* LoadGrid */ )
                {
// Go Sub  Load Grid
                    ObSbr_ST7F17();
                    if(hasReturned())
...
// Event  Event: SelectGrid
                if( getCurrentAction() == 3185 /* SelectGrid */ )
                {
// Go Sub  Select Grid
                    ObSbr_ST7F22();
                    if(hasReturned())
...
// Event  Event: RefreshGrid
                if( getCurrentAction() == 3189 /* RefreshGrid */ )
                {
// Go Sub  Reload Grid
                    ObSbr_ST7F20();
                    if(hasReturned())
...
// Event  Event: Delete
                if( getCurrentAction() == 3191 /* Delete */ )
                {
...
// Set State  Hidden, DetailP
        panel.m_ObStaticData3151.setState(12308); /* DetailP */
        panel.m_ObLabelData3153.setState(12310); /* CustomerID */
        panel.m_ObEditData3154.setState(12311); /*  */
        panel.m_ObLabelData3156.setState(12313); /* CustomerName */
        panel.m_ObEditData3157.setState(12314); /*  */
...
// Set  DetailP<CustomerID> state (2)
                    panel.m_ObLabelData3153.setState(12318); /* CustomerID */
                    panel.m_ObEditData3154.setState(12319); /*  */
...
// Set  DetailP<CustomerName> state (2)
                    panel.m_ObLabelData3156.setState(12321); /* CustomerName */
                    panel.m_ObEditData3157.setState(12322); /*  */
// If  Environment<*Focus set> == <*Focus set.*False>
                    if( v.getVariable(m_strVarST7F_Environment).getAsObCharFldField(m_strVarSqmx1ac).isEqual(m_obvalfld_10) )
                    {
...
// Set  DetailP<CustomerID> state (3)
        panel.m_ObLabelData3153.setState(12324); /* CustomerID */
        panel.m_ObEditData3154.setState(12325); /*  */
// Call  UIBASIC/Meta.ProtectVirtuals
// Comment  Copyright © 1994-1998 by Sterling Software, Inc. All Rights Reserved.
// Comment  Set the keys of the view to read-only.
// Comment  Enclose this function in a view defining meta loop.
...
// For Page  GridP
        for(long r2395 = 0;r2395 < 64;r2395++)
...
// Post Point Start reload Grid
        {
// Event  Event: Update
            if( panel.getCurrentAction() == 3193 /* Update */ )
            {
...
// For Each Row  GridP
        for(boolean r2667 = panel.m_ObGridData3158.getFirstRecord();r2667;r2667 = panel.m_ObGridData3158.getNextRecord())
...
// For Each Selected  GridP
        for(boolean r2889 = panel.m_ObGridData3158.getFirstSelected();r2889;r2889 = panel.m_ObGridData3158.getNextSelected())
...
// Set State  Hidden, GridP
        panel.m_ObGridData3158.setState(12328); /* GridP */
        panel.m_ObEditData3164.setState(12331); /* CustomerID */
        panel.m_ObColumnHeadingData3163.setState(12332); /* CustomerID */
        panel.m_ObEditData3166.setState(12334); /* CustomerName */
        panel.m_ObColumnHeadingData3165.setState(12335); /* CustomerName */
...
// If  GridL<GridRowCount> != <GridRowCount.*Zero>
                                ...
                                {
// For Each Selected  GridP
                                    for(boolean r3266 = panel.m_ObGridData3158.getFirstSelected();r3266;r3266 = panel.m_ObGridData3158.getNextSelected())
...
// Set State  Inactive, Event: Delete
            panel.m_ObPushbuttonData3171.setState(12339); /* &Delete */
...
// For Each Selected  GridP
        for(boolean r3684 = panel.m_ObGridData3158.getFirstSelected();r3684;r3684 = panel.m_ObGridData3158.getNextSelected())
