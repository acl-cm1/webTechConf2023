...
// Event:  -> Prompt 
            m_ObEditData3154.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: GridP -> LoadGrid 
            m_ObGridData3155.registerEvent(ObCtrlData.GRIDLOAD, 3198, "LoadGrid");

// Event: GridP -> SelectGrid 
            m_ObGridData3155.registerEvent(ObCtrlData.GRIDSELECTION, 3199, "SelectGrid");

// Event: GridP -> SelectRow 
            m_ObGridData3155.registerEvent(ObCtrlData.DOUBLECLICK, 3200, "SelectRow");
...
// Event: ProductID -> Prompt 
            m_ObEditData3164.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: ProductName -> Prompt 
            m_ObEditData3166.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: ProductDescription -> Prompt 
            m_ObEditData3169.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: ProductPrice -> Prompt 
            m_ObEditData3171.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: QtyInStock -> Prompt 
            m_ObEditData3173.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: &Position -> InputChanged 
            m_ObPushbuttonData3175.registerEvent(ObCtrlData.PRESSED, 3202, "InputChanged");
...
// Event:  -> RefreshGrid 
            m_ObPushbuttonData3177.registerEvent(ObCtrlData.PRESSED, 3204, "RefreshGrid");
...
// Event:  -> Prompt 
            m_ObEditData3181.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3184.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event:  -> Prompt 
            m_ObMultilineEditData3187.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3190.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3193.registerEvent(ObCtrlData.DOUBLECLICK, 3197, "Prompt");
...
// Event: &Select -> SelectRow 
            m_ObPushbuttonData3195.registerEvent(ObCtrlData.PRESSED, 3200, "SelectRow");


            accessPanel(ObCtrlData.WRITE);
            layoutWindow();

            getPanelData().registerLogicalEvent(3202, "InputChanged");
            getPanelData().registerLogicalEvent(3200, "SelectRow");
            getPanelData().registerLogicalEvent(3198, "LoadGrid");
            getPanelData().registerLogicalEvent(3204, "RefreshGrid");
            getPanelData().registerLogicalEvent(3199, "SelectGrid");
            getPanelData().registerLogicalEvent(3197, "Prompt");
            getPanelData().registerLogicalEvent(3206, "Close");
// KeyBoard Event: Prompt 
            getPanelData().registerKeyboardEvent("F4", 3197);
// Event:  -> Close 
            getPanelData().registerEvent(ObCtrlData.QUERYCLOSE, 3206, "Close");
...
// Event  Event: Close
            if( getCurrentAction() == 3206 /* Close */ )
            {
// Go Sub  Close
                ObSbr_STnF4();
                if(hasReturned())
...
// Pre Point Events
            {
// Event  Event: Prompt
                if( getCurrentAction() == 3197 /* Prompt */ )
                {
...
// Event  Event: LoadGrid
                if( getCurrentAction() == 3198 /* LoadGrid */ )
                {
// Go Sub  Load Grid
                    ObSbr_STnF7();
                    if(hasReturned())
...
// Event  Event: SelectGrid
                if( getCurrentAction() == 3199 /* SelectGrid */ )
                {
// Go Sub  Select Grid
                    ObSbr_STnF12();
                    if(hasReturned())
...
// Event  Event: RefreshGrid
                if( getCurrentAction() == 3204 /* RefreshGrid */ )
                {
// Go Sub  Reload Grid
                    ObSbr_STnF10();
                    if(hasReturned())
...
// Event  Event: SelectRow
                if( getCurrentAction() == 3200 /* SelectRow */ )
                {
...
// Event  Event: InputChanged
                if( getCurrentAction() == 3202 /* InputChanged */ )
                {
...
// For Page  GridP
        for(long r1329 = 0;r1329 < 64;r1329++)
...
// For Each Row  GridP
                        for(boolean r1439 = panel.m_ObGridData3155.getFirstRecord();r1439;r1439 = panel.m_ObGridData3155.getNextRecord())
...
// For Each Row  GridP
        for(boolean r1604 = panel.m_ObGridData3155.getFirstRecord();r1604;r1604 = panel.m_ObGridData3155.getNextRecord())
...
// For Each Selected  GridP
        for(boolean r1826 = panel.m_ObGridData3155.getFirstSelected();r1826;r1826 = panel.m_ObGridData3155.getNextSelected())
...
// Set State  Hidden, GridP
        panel.m_ObGridData3155.setState(12322); /* GridP */
        panel.m_ObEditData3164.setState(12326); /* ProductID */
        panel.m_ObColumnHeadingData3165.setState(12327); /* ProductID */
        panel.m_ObEditData3166.setState(12329); /* ProductName */
        panel.m_ObColumnHeadingData3167.setState(12330); /* ProductName */
        panel.m_ObEditData3169.setState(12332); /* ProductDescription */
        panel.m_ObColumnHeadingData3168.setState(12333); /* ProductDescription */
        panel.m_ObEditData3171.setState(12335); /* ProductPrice */
        panel.m_ObColumnHeadingData3170.setState(12336); /* ProductPrice */
        panel.m_ObEditData3173.setState(12338); /* QtyInStock */
        panel.m_ObColumnHeadingData3172.setState(12339); /* QtyInStock */
...
// Set State  Hidden, InputP
        panel.m_ObStaticData3151.setState(12344); /* InputP */
        panel.m_ObLabelData3153.setState(12346); /* ProductID */
        panel.m_ObEditData3154.setState(12347); /*  */
...
// For Each Selected  GridP
        for(boolean r2299 = panel.m_ObGridData3155.getFirstSelected();r2299;r2299 = panel.m_ObGridData3155.getNextSelected())
...
// ***************************************************************************
    ...
    final class STnF_ObDat extends ObVariableGroupX
    {
        ...
        public int STfF_STfF_FetchedData = 0; /* Product.Fetch.BlockFetch/STORAGE/FetchedData  Parm 1 */
        public int STfF_STfF_FetchedData_save = 0; /* FetchedData_save */
