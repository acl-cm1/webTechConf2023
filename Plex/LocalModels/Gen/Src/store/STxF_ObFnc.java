...
// Event:  -> UpdateProduct 
            m_ObEditData3154.registerEvent(ObCtrlData.UPDATED, 3174, "UpdateProduct");

// Event:  -> Prompt 
            m_ObEditData3154.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event:  -> UpdateCustomer 
            m_ObEditData3157.registerEvent(ObCtrlData.UPDATED, 3179, "UpdateCustomer");

// Event:  -> Prompt 
            m_ObEditData3157.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3160.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3163.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3166.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event:  -> Prompt 
            m_ObEditData3169.registerEvent(ObCtrlData.DOUBLECLICK, 3176, "Prompt");
...
// Event: &Apply -> Insert 
            m_ObPushbuttonData3171.registerEvent(ObCtrlData.PRESSED, 3181, "Insert");


            accessPanel(ObCtrlData.WRITE);
            layoutWindow();

            getPanelData().registerLogicalEvent(3179, "UpdateCustomer");
            getPanelData().registerLogicalEvent(3174, "UpdateProduct");
            getPanelData().registerLogicalEvent(3181, "Insert");
            getPanelData().registerLogicalEvent(3176, "Prompt");
            getPanelData().registerLogicalEvent(3182, "Close");
// KeyBoard Event: Prompt 
            getPanelData().registerKeyboardEvent("F4", 3176);
// Event:  -> Close 
            getPanelData().registerEvent(ObCtrlData.QUERYCLOSE, 3182, "Close");
...
// Event  Event: Close
            if( getCurrentAction() == 3182 /* Close */ )
            {
// Go Sub  Close
                ObSbr_STxF4();
                if(hasReturned())
...
// Pre Point Events
            {
// Event  Event: Prompt
                if( getCurrentAction() == 3176 /* Prompt */ )
                {
...
// Event  Event: Insert
                if( getCurrentAction() == 3181 /* Insert */ )
                {
...
// Event  Event: UpdateProduct
                if( getCurrentAction() == 3174 /* UpdateProduct */ )
                {
...
// Event  Event: UpdateCustomer
                if( getCurrentAction() == 3179 /* UpdateCustomer */ )
                {
